...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.save_sett_def_butt = QPushButton(self.page_2)
        self.save_sett_def_butt.setObjectName(u"save_sett_def_butt")
        self.save_sett_def_butt.setGeometry(QRect(80, 180, 121, 31))
        ...
        self.save_def_conf_button = QPushButton(self.page_4)
        self.save_def_conf_button.setObjectName(u"save_def_conf_button")
        self.save_def_conf_button.setGeometry(QRect(140, 390, 121, 31))
        ...
        self.rotors_list.setGeometry(QRect(60, 80, 231, 161))
        ...
        self.load_conf_button = QPushButton(self.page_4)
        self.load_conf_button.setObjectName(u"load_conf_button")
        self.load_conf_button.setGeometry(QRect(380, 20, 211, 21))
        self.export_button = QPushButton(self.page_4)
        self.export_button.setObjectName(u"export_button")
        self.export_button.setGeometry(QRect(370, 390, 121, 31))
        self.restore_conf_button = QPushButton(self.page_4)
        self.restore_conf_button.setObjectName(u"restore_conf_button")
        self.restore_conf_button.setGeometry(QRect(380, 50, 211, 21))
        ...
        self.rotors_list_2.setGeometry(QRect(20, 110, 221, 261))
        ...
        self.add_from_file_rotor_button = QPushButton(self.page_5)
        self.add_from_file_rotor_button.setObjectName(u"add_from_file_rotor_button")
        self.add_from_file_rotor_button.setGeometry(QRect(80, 390, 101, 23))
        ...
        self.add_from_file_rotor_button.raise_()
        self.page_8 = QWidget()
        ...
        self.reflectors_list.setGeometry(QRect(20, 110, 221, 261))
        self.add_from_file_ref_butt = QPushButton(self.page_8)
        self.add_from_file_ref_butt.setObjectName(u"add_from_file_ref_butt")
        self.add_from_file_ref_butt.setGeometry(QRect(80, 390, 101, 23))
        ...
        self.menubar.setGeometry(QRect(0, 0, 657, 20))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.save_sett_def_butt.setText(QCoreApplication.translate("MainWindow", u"Save as default", None))
        ...
        self.save_def_conf_button.setText(QCoreApplication.translate("MainWindow", u"Save as default", None))
        ...
        self.load_conf_button.setText(QCoreApplication.translate("MainWindow", u"Load configuration from file", None))
        self.export_button.setText(QCoreApplication.translate("MainWindow", u"Export", None))
        self.restore_conf_button.setText(QCoreApplication.translate("MainWindow", u"Restore default configuration", None))
        ...
        self.add_from_file_rotor_button.setText(QCoreApplication.translate("MainWindow", u"Add from file", None))
        ...
        self.add_from_file_ref_butt.setText(QCoreApplication.translate("MainWindow", u"Add from file", None))
